...
mixin _$ParkingLotModel {
 ...
 String get id; String get name; bool get isOpen; int get camerasCount; int get totalSlots; double get occupancy; int get revenueToday; double get pricePerHour; String get address; double get latitude; double get longitude;@JsonKey(name: 'entrance_logical_locations') List<List<int>>? get entranceLogicalLocations;@JsonKey(name: 'slot_width_meters') double? get slotWidthMeters;@JsonKey(name: 'slot_length_meters') double? get slotLengthMeters; double? get distanceMeters; double? get rating; int? get ratingCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,isOpen,camerasCount,totalSlots,occupancy,revenueToday,pricePerHour,address,latitude,longitude,const DeepCollectionEquality().hash(entranceLogicalLocations),slotWidthMeters,slotLengthMeters,distanceMeters,rating,ratingCount);

@override
String toString() {
  return 'ParkingLotModel(id: $id, name: $name, isOpen: $isOpen, camerasCount: $camerasCount, totalSlots: $totalSlots, occupancy: $occupancy, revenueToday: $revenueToday, pricePerHour: $pricePerHour, address: $address, latitude: $latitude, longitude: $longitude, entranceLogicalLocations: $entranceLogicalLocations, slotWidthMeters: $slotWidthMeters, slotLengthMeters: $slotLengthMeters, distanceMeters: $distanceMeters, rating: $rating, ratingCount: $ratingCount)';
}
...
/// Create a copy of ParkingLotModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? isOpen = null,Object? camerasCount = null,Object? totalSlots = null,Object? occupancy = null,Object? revenueToday = null,Object? pricePerHour = null,Object? address = null,Object? latitude = null,Object? longitude = null,Object? entranceLogicalLocations = freezed,Object? slotWidthMeters = freezed,Object? slotLengthMeters = freezed,Object? distanceMeters = freezed,Object? rating = freezed,Object? ratingCount = freezed,}) {
...
switch (_that) {
case _ParkingLotModel() when $default != null:
return $default(_that.id,_that.name,_that.isOpen,_that.camerasCount,_that.totalSlots,_that.occupancy,_that.revenueToday,_that.pricePerHour,_that.address,_that.latitude,_that.longitude,_that.entranceLogicalLocations,_that.slotWidthMeters,_that.slotLengthMeters,_that.distanceMeters,_that.rating,_that.ratingCount);case _:
  return orElse();
...
class _ParkingLotModel implements ParkingLotModel {
  const _ParkingLotModel({required this.id, required this.name, required this.isOpen, required this.camerasCount, required this.totalSlots, required this.occupancy, required this.revenueToday, this.pricePerHour = 50.0, required this.address, required this.latitude, required this.longitude, @JsonKey(name: 'entrance_logical_locations') final  List<List<int>>? entranceLogicalLocations, @JsonKey(name: 'slot_width_meters') this.slotWidthMeters, @JsonKey(name: 'slot_length_meters') this.slotLengthMeters, this.distanceMeters, this.rating, this.ratingCount}): _entranceLogicalLocations = entranceLogicalLocations;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,isOpen,camerasCount,totalSlots,occupancy,revenueToday,pricePerHour,address,latitude,longitude,const DeepCollectionEquality().hash(_entranceLogicalLocations),slotWidthMeters,slotLengthMeters,distanceMeters,rating,ratingCount);
...
/// Create a copy of ParkingLotModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? isOpen = null,Object? camerasCount = null,Object? totalSlots = null,Object? occupancy = null,Object? revenueToday = null,Object? pricePerHour = null,Object? address = null,Object? latitude = null,Object? longitude = null,Object? entranceLogicalLocations = freezed,Object? slotWidthMeters = freezed,Object? slotLengthMeters = freezed,Object? distanceMeters = freezed,Object? rating = freezed,Object? ratingCount = freezed,}) {
