...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,slotId,startTime,endTime,vehicle,durationMinutes,paymentMethod,totalPrice,baseRate,checkInTime,checkOutTime,actualEndTime,totalBilledPrice,status,qrCodeToken,lotName,lotAddress,lotLatitude,lotLongitude,slotName,createdAt,updatedAt]);

@override
String toString() {
  return 'ReservationModel(id: $id, userId: $userId, slotId: $slotId, startTime: $startTime, endTime: $endTime, vehicle: $vehicle, durationMinutes: $durationMinutes, paymentMethod: $paymentMethod, totalPrice: $totalPrice, baseRate: $baseRate, checkInTime: $checkInTime, checkOutTime: $checkOutTime, actualEndTime: $actualEndTime, totalBilledPrice: $totalBilledPrice, status: $status, qrCodeToken: $qrCodeToken, lotName: $lotName, lotAddress: $lotAddress, lotLatitude: $lotLatitude, lotLongitude: $lotLongitude, slotName: $slotName, createdAt: $createdAt, updatedAt: $updatedAt)';
}
