...
mixin _$ApiResponse<T> {
 ...
 bool get success; String get message;@JsonKey(unknownEnumValue: ResponseCode.unknown) ResponseCode get code; int get statusCode; T? get data;
...
@override
String toString() {
  return 'ApiResponse<$T>(success: $success, message: $message, code: $code, statusCode: $statusCode, data: $data)';
}
...
@useResult
$Res call({
 bool success, String message,@JsonKey(unknownEnumValue: ResponseCode.unknown) ResponseCode code, int statusCode, T? data
});
...
as ResponseCode,statusCode: null == statusCode ? _self.statusCode : statusCode // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool success,  String message, @JsonKey(unknownEnumValue: ResponseCode.unknown)  ResponseCode code,  int statusCode,  T? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool success,  String message, @JsonKey(unknownEnumValue: ResponseCode.unknown)  ResponseCode code,  int statusCode,  T? data)  $default,) {final _that = this;
switch (_that) {
case _ApiResponse():
return $default(_that.success,_that.message,_that.code,_that.statusCode,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool success,  String message, @JsonKey(unknownEnumValue: ResponseCode.unknown)  ResponseCode code,  int statusCode,  T? data)?  $default,) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
return $default(_that.success,_that.message,_that.code,_that.statusCode,_that.data);case _:
  return null;
...
class _ApiResponse<T> extends ApiResponse<T> {
  const _ApiResponse({required this.success, required this.message, @JsonKey(unknownEnumValue: ResponseCode.unknown) required this.code, required this.statusCode, this.data}): super._();
...
@override@JsonKey(unknownEnumValue: ResponseCode.unknown) final  ResponseCode code;
