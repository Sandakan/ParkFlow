...
mixin _$CreateParkingLotRequest {
 ...
 String get name; String get address; double get latitude; double get longitude;@JsonKey(name: 'total_slots') int get totalSlots;@JsonKey(name: 'entrance_logical_locations') List<List<int>> get entranceLogicalLocations;@JsonKey(name: 'slot_width_meters') double get slotWidthMeters;@JsonKey(name: 'slot_length_meters') double get slotLengthMeters;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,address,latitude,longitude,totalSlots,const DeepCollectionEquality().hash(entranceLogicalLocations),slotWidthMeters,slotLengthMeters);

@override
String toString() {
  return 'CreateParkingLotRequest(name: $name, address: $address, latitude: $latitude, longitude: $longitude, totalSlots: $totalSlots, entranceLogicalLocations: $entranceLogicalLocations, slotWidthMeters: $slotWidthMeters, slotLengthMeters: $slotLengthMeters)';
}
...
@useResult
$Res call({
 String name, String address, double latitude, double longitude,@JsonKey(name: 'total_slots') int totalSlots,@JsonKey(name: 'entrance_logical_locations') List<List<int>> entranceLogicalLocations,@JsonKey(name: 'slot_width_meters') double slotWidthMeters,@JsonKey(name: 'slot_length_meters') double slotLengthMeters
});
...
/// Create a copy of CreateParkingLotRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? address = null,Object? latitude = null,Object? longitude = null,Object? totalSlots = null,Object? entranceLogicalLocations = null,Object? slotWidthMeters = null,Object? slotLengthMeters = null,}) {
...
as int,entranceLogicalLocations: null == entranceLogicalLocations ? _self.entranceLogicalLocations : entranceLogicalLocations // ignore: cast_nullable_to_non_nullable
as List<List<int>>,slotWidthMeters: null == slotWidthMeters ? _self.slotWidthMeters : slotWidthMeters // ignore: cast_nullable_to_non_nullable
as double,slotLengthMeters: null == slotLengthMeters ? _self.slotLengthMeters : slotLengthMeters // ignore: cast_nullable_to_non_nullable
as double,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String address,  double latitude,  double longitude, @JsonKey(name: 'total_slots')  int totalSlots, @JsonKey(name: 'entrance_logical_locations')  List<List<int>> entranceLogicalLocations, @JsonKey(name: 'slot_width_meters')  double slotWidthMeters, @JsonKey(name: 'slot_length_meters')  double slotLengthMeters)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateParkingLotRequest() when $default != null:
return $default(_that.name,_that.address,_that.latitude,_that.longitude,_that.totalSlots,_that.entranceLogicalLocations,_that.slotWidthMeters,_that.slotLengthMeters);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String address,  double latitude,  double longitude, @JsonKey(name: 'total_slots')  int totalSlots, @JsonKey(name: 'entrance_logical_locations')  List<List<int>> entranceLogicalLocations, @JsonKey(name: 'slot_width_meters')  double slotWidthMeters, @JsonKey(name: 'slot_length_meters')  double slotLengthMeters)  $default,) {final _that = this;
switch (_that) {
case _CreateParkingLotRequest():
return $default(_that.name,_that.address,_that.latitude,_that.longitude,_that.totalSlots,_that.entranceLogicalLocations,_that.slotWidthMeters,_that.slotLengthMeters);case _:
  throw StateError('Unexpected subclass');
...
class _CreateParkingLotRequest extends CreateParkingLotRequest {
  const _CreateParkingLotRequest({required this.name, required this.address, required this.latitude, required this.longitude, @JsonKey(name: 'total_slots') required this.totalSlots, @JsonKey(name: 'entrance_logical_locations') required final  List<List<int>> entranceLogicalLocations, @JsonKey(name: 'slot_width_meters') required this.slotWidthMeters, @JsonKey(name: 'slot_length_meters') required this.slotLengthMeters}): _entranceLogicalLocations = entranceLogicalLocations,super._();
...
@override@JsonKey(name: 'entrance_logical_locations') List<List<int>> get entranceLogicalLocations {
  ...
  return EqualUnmodifiableListView(_entranceLogicalLocations);
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,address,latitude,longitude,totalSlots,const DeepCollectionEquality().hash(_entranceLogicalLocations),slotWidthMeters,slotLengthMeters);
...
/// Create a copy of CreateParkingLotRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? address = null,Object? latitude = null,Object? longitude = null,Object? totalSlots = null,Object? entranceLogicalLocations = null,Object? slotWidthMeters = null,Object? slotLengthMeters = null,}) {
...
as double,longitude: null == longitude ? _self.longitude : longitude // ignore: cast_nullable_to_non_nullable
as double,totalSlots: null == totalSlots ? _self.totalSlots : totalSlots // ignore: cast_nullable_to_non_nullable
as int,entranceLogicalLocations: null == entranceLogicalLocations ? _self._entranceLogicalLocations : entranceLogicalLocations // ignore: cast_nullable_to_non_nullable
as List<List<int>>,slotWidthMeters: null == slotWidthMeters ? _self.slotWidthMeters : slotWidthMeters // ignore: cast_nullable_to_non_nullable
as double,slotLengthMeters: null == slotLengthMeters ? _self.slotLengthMeters : slotLengthMeters // ignore: cast_nullable_to_non_nullable
as double,
  ));
