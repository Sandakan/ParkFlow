...
class CreateParkingLotRequest(BaseModel):
    ...
    price_per_hour: float = Field(default=0.0, description="Price per hour for parking in this lot", ge=0)
...
class UpdateParkingLotRequest(BaseModel):
    ...
    price_per_hour: Optional[float] = Field(None, description="Price per hour for parking in this lot", ge=0)
